        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-3">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
              <p className="text-sm font-semibold text-slate-900">1. Cadastro rápido</p>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
              <p className="text-sm font-semibold text-slate-900">2. Pagamento seguro</p>
              <p className="mt-1 text-xs leading-5 text-slate-600">
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
              <p className="text-sm font-semibold text-slate-900">3. Acompanhamento</p>
              <p className="mt-1 text-xs leading-5 text-slate-600">
